...
const titles: Title[] = [
  ...
  { id: 'laapataa-ladies', name: 'Laapataa Ladies', year: 2024, region: 'Bollywood', type: 'Film', genres: ['Comedy', 'Drama'], runtime: '2h 2m', score: '8.4', description: 'Two brides get separated from their husbands on a train ride. A warm, sharp little story about identity and the freedom to find it.', poster: 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#efaa5c,#b8525a 57%,#381b37)', streaming: 'Netflix', streamingUrl: 'https://www.netflix.com/', imdb: 'https://www.imdb.com/title/tt21626284/', letterboxd: 'https://letterboxd.com/film/laapataa-ladies/', trailer: 'https://www.youtube.com/watch?v=s3MRx2q3J9g' },
  { id: '12th-fail', name: '12th Fail', year: 2023, region: 'Bollywood', type: 'Film', genres: ['Biography', 'Drama'], runtime: '2h 27m', score: '9.0', description: 'A young man from a small town refuses to let one exam decide the size of his life.', poster: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#d68050,#294f69 65%,#101921)', streaming: 'Disney+ Hotstar', streamingUrl: 'https://www.hotstar.com/', imdb: 'https://www.imdb.com/title/tt23849204/', letterboxd: 'https://letterboxd.com/film/12th-fail/', trailer: 'https://www.youtube.com/watch?v=WeMJo701mvQ' },
  { id: 'rrr', name: 'RRR', year: 2022, region: 'Tollywood', type: 'Film', genres: ['Action', 'Epic'], runtime: '3h 7m', score: '7.8', description: 'Two revolutionaries, an impossible friendship, and a dance number that bends the physics of joy.', poster: 'https://images.unsplash.com/photo-1440404653325-ab127d49abc1?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#e45f34,#e6b64e 55%,#1c3347)', streaming: 'Netflix', streamingUrl: 'https://www.netflix.com/', imdb: 'https://www.imdb.com/title/tt8178634/', letterboxd: 'https://letterboxd.com/film/rrr/', trailer: 'https://www.youtube.com/watch?v=NgBoMJy386M' },
  { id: 'tumbbad', name: 'Tumbbad', year: 2018, region: 'Bollywood', type: 'Film', genres: ['Horror', 'Fantasy'], runtime: '1h 44m', score: '8.2', description: 'A man ventures into a cursed village to harvest a forgotten goddess’s endless gold.', poster: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#604d26,#201817 56%,#ae542e)', streaming: 'Prime Video', streamingUrl: 'https://www.primevideo.com/', imdb: 'https://www.imdb.com/title/tt8239946/', letterboxd: 'https://letterboxd.com/film/tumbbad/', trailer: 'https://www.youtube.com/watch?v=sN75mpium8k' },
  { id: 'the-bear', name: 'The Bear', year: 2022, region: 'Hollywood', type: 'Series', genres: ['Comedy', 'Drama'], runtime: '3 seasons', score: '8.5', description: 'In a kitchen where every service is personal, a young chef tries to make something worth coming back to.', poster: 'https://images.unsplash.com/photo-1574267432553-4b4628081c31?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#bd4e37,#20242f 59%,#e6a95e)', streaming: 'Disney+ Hotstar', streamingUrl: 'https://www.hotstar.com/', imdb: 'https://www.imdb.com/title/tt14452776/', letterboxd: 'https://letterboxd.com/film/the-bear/', trailer: 'https://www.youtube.com/watch?v=gBmkI4jlaIo' },
  { id: 'severance', name: 'Severance', year: 2022, region: 'Hollywood', type: 'Series', genres: ['Mystery', 'Sci-fi'], runtime: '2 seasons', score: '8.7', description: 'A surgical split between work and life turns a quiet office into an elegant, existential nightmare.', poster: 'https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#9ab8ad,#29394a 65%,#121720)', streaming: 'Apple TV+', streamingUrl: 'https://tv.apple.com/', imdb: 'https://www.imdb.com/title/tt11280740/', letterboxd: 'https://letterboxd.com/film/severance/', trailer: 'https://www.youtube.com/watch?v=xEQP4VVuyrY' },
  { id: 'scam-1992', name: 'Scam 1992', year: 2020, region: 'Bollywood', type: 'Series', genres: ['Biography', 'Crime'], runtime: '10 episodes', score: '9.2', description: 'The rise and fall of a stock-market legend, told with swagger, rhythm, and a very good soundtrack.', poster: 'https://images.unsplash.com/photo-1535016120720-40c646be5580?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#d97b3f,#50412c 60%,#1d2529)', streaming: 'SonyLIV', streamingUrl: 'https://www.sonyliv.com/', imdb: 'https://www.imdb.com/title/tt12392504/', letterboxd: 'https://letterboxd.com/film/scam-1992-the-harshad-mehta-story/', trailer: 'https://www.youtube.com/watch?v=ISORfezBh9E' },
  { id: 'panchayat', name: 'Panchayat', year: 2020, region: 'Bollywood', type: 'Series', genres: ['Comedy', 'Drama'], runtime: '3 seasons', score: '8.9', description: 'A reluctant city graduate finds an unexpected rhythm in the smallest office in rural India.', poster: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#74a8a0,#e1aa60 63%,#37293d)', streaming: 'Prime Video', streamingUrl: 'https://www.primevideo.com/', imdb: 'https://www.imdb.com/title/tt12004706/', letterboxd: 'https://letterboxd.com/film/panchayat/', trailer: 'https://www.youtube.com/watch?v=mojZJ7oeD_g' },
  { id: 'mahanati', name: 'Mahanati', year: 2018, region: 'Tollywood', type: 'Film', genres: ['Biography', 'Drama'], runtime: '2h 57m', score: '8.5', description: 'The luminous, bittersweet story of an actor whose stardom could not protect her from the cost of being adored.', poster: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#db8b9a,#43335b 63%,#151522)', streaming: 'Prime Video', streamingUrl: 'https://www.primevideo.com/', imdb: 'https://www.imdb.com/title/tt6908274/', letterboxd: 'https://letterboxd.com/film/mahanati/', trailer: 'https://www.youtube.com/watch?v=9w8RzZ5Yw7Q' },
  { id: 'blue-eye-samurai', name: 'Blue Eye Samurai', year: 2023, region: 'International', type: 'Series', genres: ['Animation', 'Action'], runtime: '8 episodes', score: '8.7', description: 'A master of the sword walks through Edo-period Japan with a blue-eyed secret and a very long memory.', poster: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&w=700&q=85', gradient: 'linear-gradient(145deg,#187485,#da5b4f 60%,#151c3c)', streaming: 'Netflix', streamingUrl: 'https://www.netflix.com/', imdb: 'https://www.imdb.com/title/tt13309742/', letterboxd: 'https://letterboxd.com/film/blue-eye-samurai/', trailer: 'https://www.youtube.com/watch?v=nJ1yQn17lbE' },
];
...
function PosterCard({ title, saved, onSelect, onToggleSave, index }: { title: Title; saved: boolean; onSelect: () => void; onToggleSave: () => void; index: number }) {
  return (
    <article className="poster-card" style={{ animationDelay: `${index * 45}ms` }} onClick={onSelect} onKeyDown={(event) => { if (event.key === 'Enter' || event.key === ' ') { event.preventDefault(); onSelect(); } }} tabIndex={0} role="button" aria-label={`View ${title.name} thumbnail`} data-testid={`card-title-${title.id}`}>
      <div className="poster-frame">
        ...
        <div className="poster-hover-cta"><Info size={12} /> View thumbnail</div>
      </div>
      <div className="poster-copy">
        <button className="poster-title" onClick={(event) => { event.stopPropagation(); onSelect(); }} data-testid={`text-title-${title.id}`}>{title.name}</button>
        ...
        <main>
          <section className="section-shell hero" aria-labelledby="hero-title">
            ...
            <div className="feature-wrap">
              <div className="feature-card" onClick={() => selectTitle(titles[0].id)} onKeyDown={(event) => { if (event.key === 'Enter' || event.key === ' ') { event.preventDefault(); selectTitle(titles[0].id); } }} role="button" tabIndex={0} aria-label={`View ${titles[0].name} thumbnail`}>
                <div className="feature-art"><Poster title={titles[0]} bare /><div className="feature-geometry" /></div>
